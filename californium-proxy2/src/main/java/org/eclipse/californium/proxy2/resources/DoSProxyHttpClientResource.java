 ...
 * URI-host, or URI-port option set to the desired http server. Optimized
 * for DoS attacks.
 * 
 * @author amirf@mit.edu
 */
public class DoSProxyHttpClientResource extends ProxyCoapResource {

	private static final Logger LOGGER = LoggerFactory.getLogger(DoSProxyHttpClientResource.class);
	 ...
	 */
	private static final CloseableHttpAsyncClient asyncClient = DoSHttpClientFactory.createCustomClient();
	 ...
	 *            used.
	 */
	public DoSProxyHttpClientResource(String name, boolean visible, boolean accept, Coap2HttpTranslator translator,
			String... schemes) {
